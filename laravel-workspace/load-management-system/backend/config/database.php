...
return [
    ...
    */
    ...
    'connections' => [
        ...
        /*
        |--------------------------------------------------------------------
        | PRIMARY: PostgreSQL — Users & Authentication
        |--------------------------------------------------------------------
        */
        'pgsql' => [
            'driver'         => 'pgsql',
            ...
            'database'       => env('DB_PGSQL_DATABASE', 'microfinance_auth'),
        ...
        /*
        |--------------------------------------------------------------------
        | SECONDARY: MySQL — Loans & Repayment Schedules
        |--------------------------------------------------------------------
        */
        'mysql' => [
            'driver'         => 'mysql',
            ...
            'database'       => env('DB_MYSQL_DATABASE', 'microfinance_loans'),
